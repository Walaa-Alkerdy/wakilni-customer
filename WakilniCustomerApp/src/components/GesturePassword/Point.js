...
export default class Point extends Component {
    ...
    constructor(props) {
        ...
        this._innerCircleRadius = this._outerCircleRadius / 7
        this._innerCirclePosition = {
            left: this._innerCircleRadius * 6 - props.borderWidth,
            top: this._innerCircleRadius * 6 - props.borderWidth,
        }
    ...
    render() {
        ...
        return (
            <Circle
                ...
                <Circle
                    isFill={true}
                    color={this.props.isActive ? this.props.activeColor : '#ffffff'}
